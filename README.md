...
These historical results show the brute-force traversal cost before BVH
integration; they are not post-BVH measurements. Compare the current renderer
against them with:
...
- BVH construction uses median centroid splits without SAH, refitting, or
  instancing.
